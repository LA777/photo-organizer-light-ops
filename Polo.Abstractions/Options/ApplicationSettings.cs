...
public class ApplicationSettings
{
    ...
    public uint ImageResizeLongSideLimit { get; set; }
    ...
    [Range(1, uint.MaxValue, ErrorMessage = "ERROR: Value for {0} should be between {1} and {2}.")]
    public uint FsivThumbnailSize { get; set; }
