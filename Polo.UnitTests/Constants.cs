...
public static class FileExtension
{
    ...
    public static ICollection<string> JpegExtensions = [Jpg, Jpeg];
    public static ICollection<string> RawExtensions = [Orf, Crw, Cr2, Cr3, _3fr, Mef, Nef, Nrw, Pef, Ptx, Rw2, Arw, Srf, Sr2, Gpr, Raf, Raw, Rwl, Dng, Srw, X3f];
    public static ICollection<string> VideoExtensions = [Mkv, Avi, M2ts, Ts, Mp4, M4v, M4p, Mpg, Mpeg];
}
