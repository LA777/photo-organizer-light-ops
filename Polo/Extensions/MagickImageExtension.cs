...
public static class MagickImageExtension
{
    ...
    {
        var transparentBitmap = new Bitmap((int)magickImage.Width, (int)magickImage.Height);
    ...
    public static void ResizeByMegapixelsLimit(this MagickImage magickImage, float megaPixelsLimit, MagickImageInfo magickImageInfo)
    {
        ...
        var expectedWidth = (uint)Math.Floor(Math.Sqrt(diff));
    ...
    public static void ResizeByLongSide(this MagickImage magickImage, uint longSideLimit, MagickImageInfo magickImageInfo)
    {
